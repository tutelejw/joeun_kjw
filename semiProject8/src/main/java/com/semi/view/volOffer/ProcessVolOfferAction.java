...
public class ProcessVolOfferAction extends Action {
...
//        }
        ...
        VolOffer item = service.getVolOffer(volunteerId);
        if (item == null) {
        ...
        if (applicantId.equals(item.getAuthorId())) {
            ...
            return "redirect:/detailVolOffer.do?volunteerId=" + volunteerId + qs;
        }
