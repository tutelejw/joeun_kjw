...
<table width="100%" height="37" border="0" cellpadding="0"	cellspacing="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
		...
		<tr>
		    ...
		    <td bgcolor="D6D6D6" width="1"></td>
		    <td class="ct_write01">        <input type="text" name="title" value="${volOffer.title}">    </td>
		</tr>
        
        <tr>      <td height="1" colspan="3" bgcolor="D6D6D6"></td>  </tr>  
		<tr>  
		    <td width="104" class="ct_write">손길나눔 시작시간</td>      <td bgcolor="D6D6D6" width="1"></td>  
		    <td class="ct_write01">        <input type="datetime-local" name="startTime" value="${volOffer.startTime}">    </td>  
		</tr>      
        
        <tr>      <td height="1" colspan="3" bgcolor="D6D6D6"></td>  </tr>  
		<tr>  
		    <td width="104" class="ct_write">손길나눔 종료시간</td>      <td bgcolor="D6D6D6" width="1"></td>  
		    <td class="ct_write01">        <input type="datetime-local" name="endTime" value="${volOffer.endTime}">    </td>  
		</tr>

		<tr>    <td height="1" colspan="3" bgcolor="D6D6D6"></td></tr>
		<tr>
		    <td width="104" class="ct_write">손길나눔 내용</td>    <td bgcolor="D6D6D6" width="1"></td>
		    <td class="ct_write01">        <input type="text" name="content" value="${volOffer.content}">
		    </td>
		</tr>
        
        <tr>		            <td height="1" colspan="3" bgcolor="D6D6D6"></td>        </tr>
        <tr>		
            <td width="104" class="ct_write">전화번호</td>		            <td bgcolor="D6D6D6" width="1"></td>
            <td class="ct_write01">${volOffer.phone}</td>
        </tr>
        
        <tr>		            <td height="1" colspan="3" bgcolor="D6D6D6"></td>        </tr>
        <tr>		
            <td width="104" class="ct_write">지역</td>		            <td bgcolor="D6D6D6" width="1"></td>
            <td class="ct_write01">${volOffer.region}</td>
        </tr>
        
        <tr>		            <td height="1" colspan="3" bgcolor="D6D6D6"></td>        </tr>
        <tr>		
            <td width="104" class="ct_write">카테고리</td>		            <td bgcolor="D6D6D6" width="1"></td>
