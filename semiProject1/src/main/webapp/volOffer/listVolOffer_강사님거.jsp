...
<!-- 추가: 테이블 스타일을 위한 CSS 삽입 -->
  <style>
    /* 테이블을 중앙에 정렬하고 최대 너비 설정 */
    .center-table {
      margin: 20px auto;              /* 좌우 중앙 정렬 및 상하 여백 설정 */
      width: 100%;
      max-width: 800px;              /* 최대 너비 제한 */
      table-layout: fixed;           /* 셀 너비 자동 배분 */
      border-collapse: collapse;     /* 테두리 겹침 제거 */
      background-color: rgba(255,255,255,0.9); /* 반투명한 흰 배경 적용 */
    }
    .center-table th, .center-table td {
      padding: 10px;
      text-align: center;
      border: 1px solid #ccc;
      background-color: rgba(255,255,255,0.8); /* 셀별 반투명 적용 */
    }
    .center-table th {
      background-color: rgba(200,200,200,0.85); /* 헤더는 조금 더 진한 반투명색 */
      font-weight: bold;
    }
  </style>
  <!-- 여기까지 추가 -->
