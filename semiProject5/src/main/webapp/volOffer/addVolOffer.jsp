...
<div class="container-main">
  <div class="hero">
    <div class="title">봉사제공 등록</div>

    <form method="post" action="<c:url value='/addVolOffer.do'/>" enctype="multipart/form-data" style="display:grid; grid-template-columns: 1fr 1fr; gap:18px;">
      ...
      <div style="grid-column: 1 / span 2; display:flex; gap:8px; justify-content:flex-end; margin-top:8px;">
        <a href="<c:url value='/listVolOffer.do'/>" class="btn">취소</a>
