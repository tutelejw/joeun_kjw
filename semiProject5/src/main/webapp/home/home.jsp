    ...
    <div class="home-slider-viewport" aria-live="polite">
      <div class="home-slider-track">
        ...
        <div class="home-slider-item">
          <img src="https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=1600&auto=format&fit=crop" alt="따뜻한 햇살과 숲길">
        </div>
        <!-- slide 2 -->
        <div class="home-slider-item">
          <img src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?q=80&w=1600&auto=format&fit=crop" alt="도시와 하늘">
        </div>
        <!-- slide 3 -->
        <div class="home-slider-item">
          <img src="https://images.unsplash.com/photo-1482192505345-5655af888cc4?q=80&w=1600&auto=format&fit=crop" alt="손 모양의 실루엣">
        </div>
        <!-- slide 4 -->
        <div class="home-slider-item">
          <img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=1600&auto=format&fit=crop" alt="해변과 구름">
        </div>
        <!-- slide 5 -->
        <div class="home-slider-item">
          <img src="https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?q=80&w=1600&auto=format&fit=crop" alt="야경과 사람들">
        </div>
      </div>
    </div>
