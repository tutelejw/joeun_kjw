...
public class FindOddException extends Exception { // Exception 클래스를 상속받아 사용자 정의 예외 클래스를 정의합니다.
    ...
    public void test(int number) throws FindOddException { // throws 키워드는 이 메소드가 FindOddException을 발생시킬 수 있음을 선언합니다.
        ...
        if (number == 0) {
            ...
            throw new FindOddException("number is '0' 발생!!!!"); 
        }
    ...
    public static void main(String[] args) {
        ...
        FindOddException testMe = new FindOddException(); 
        ...
        } catch (FindOddException e) { // FindOddException 타입의 예외가 발생하면 이 catch 블록이 실행됩니다.
