...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
    ...
    <tr>
        ...
        <td class="ct_write01">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="105">ProdNo : ${vo.purchaseProd.prodNo}</td>
                    <td></td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        ...
        <td class="ct_write01">
            <c:choose>
                <c:when test="${vo.paymentOption == '1'}">현금구매</c:when>
                <c:when test="${vo.paymentOption == '2'}">신용구매</c:when>
    ...
    <tr>
        ...
        <td bgcolor="D6D6D6" width="1"></td>
        <td class="ct_write01">${vo.buyer.userName}</td>
    </tr>
    ...
    <tr>
        <td class="ct_write">배송희망일</td>
        <td bgcolor="D6D6D6" width="1"></td>
        <td class="ct_write01">${vo.divyDate}</td>
<%--              <fmt:formatDate value="${vo.divyDate}" />  --%>
<%--             <fmt:formatDate value="${vo.divyDate}" pattern="yyyy-MM-dd" /> --%>
        </td>
    </tr>
    ...
    <tr>
        <td class="ct_write">주문일</td>
        <td bgcolor="D6D6D6" width="1"></td>
        <td class="ct_write01">
            <fmt:formatDate value="${vo.orderDate}" pattern="yyyy-MM-dd HH:mm:ss" />
        </td>
    </tr>
