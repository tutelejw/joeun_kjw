...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
					ProdNo : <%= vo.getPurchaseProd().getProdNo() %></td>
					<td></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td class="ct_write01">
			       ..<%=vo.getPaymentOption()%>.. 
			               <%
            String paymentOption = String.valueOf(vo.getPaymentOption()).trim();
        %>
        <%= "1".equals(paymentOption) ? "현금구매" :
             "2".equals(paymentOption) ? "신용구매" : "기타" %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo.getBuyer().getUserName()%></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
