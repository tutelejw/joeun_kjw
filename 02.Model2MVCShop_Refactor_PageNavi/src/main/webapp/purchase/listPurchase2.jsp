...
<%
    ...
    int totalPage = (total + search.getPageSize() - 1) / search.getPageSize();

    String condition = search.getSearchCondition() != null ? search.getSearchCondition() : "";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<%
    int no = total - (currentPage - 1) * search.getPageSize();
